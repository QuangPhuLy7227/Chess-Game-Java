...
public class Game {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage all=ImageIO.read(new File("C:\\Users\\Owner\\Downloads\\chess.png"));
        ...
        System.out.println(wpawn1.isValid("rook", 1,6,7,2));
        ...
        frame.addMouseMotionListener(new MouseMotionListener() {
            ...
            public void mouseDragged(MouseEvent e) {
                if (piece.selectedPiece != null){
                    piece.selectedPiece.x = e.getX()-32;
                    piece.selectedPiece.y = e.getY()-32;
                    frame.repaint();
                }
            }
        ...
        frame.addMouseListener(new MouseListener() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                piece.selectedPiece = getPiece(e.getX(), e.getY());
                piece.name = piece.selectedPiece.name;
                piece.fromX = e.getX()/64;
                piece.fromY = e.getY()/64;
            }
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                System.out.print(piece.fromX + ":" + piece.fromY + " -- " + piece.toX + ":" + piece.toY + " ");
                piece.selectedPiece.move(piece.name, piece.fromX, piece.fromY,piece.toX, piece.toY);
                frame.repaint();
            }
